...
// ── FOOD ESTIMATE (local) ─────────────────────────────────────────────────
const FOODDB = [
  { kw:["taco de carnitas","taco carnitas","tacos de carnitas","tacos carnitas"], k:110 }, { kw:["taco de pollo","tacos de pollo","taco pollo"], k:120 }, { kw:["taco al pastor","taco pastor"], k:180 }, { kw:["taco"], k:150 },
  ...
  { kw:["café","cafe","té","te"], k:5 }, { kw:["fuze tea negro","fuze tea","fuzetea negro","fuzetea","fuze tea black"], k:5 }, { kw:["sidral mundet","refresco de manzana mundet","refresco mundet","mundet"], k:71 }, { kw:["refresco","coca"], k:150 },
  ...
  { kw:["pasta","espagueti"], k:300 }, { kw:["yakimeshi","arroz frito japonés","arroz frito japones"], k:450 }, { kw:["teppanyaki de res","teppanyaki de pollo","teppanyaki de camarón","teppanyaki de camaron","teppanyaki"], k:300 }, { kw:["rollos de sushi","rolls de sushi","rollos sushi","rollo de sushi","roll de sushi","rollo sushi"], k:200 }, { kw:["pieza de sushi","piezas de sushi","sushi"], k:50 }, { kw:["ensalada"], k:150 }, { kw:["caldo tlalpeño","caldo tlalpeno","tlalpeño","tlalpeno"], k:320 }, { kw:["sopa","caldo"], k:180 },
  ...
  { kw:["milanesas de pollo empanizadas","milanesas de pollo","pechuga empanizada","pollo empanizado","milanesa de pollo empanizada","milanesa de pollo","milanesa pollo"], k:232 }, { kw:["milanesas de res empanizadas","milanesas de res","milanesa de res empanizada","milanesa de res","milanesa empanizada","milanesa"], k:285 }, { kw:["arroz con leche"], k:284 }, { kw:["sopa de fideo","fideo","fideos"], k:180 }, { kw:["empanada de elote","empanadas de elote"], k:220 }, { kw:["empanada de espinaca","empanada de espinacas","empanadas de espinaca"], k:200 }, { kw:["pan árabe","pan arabe","pan pita","pita"], k:150 }, { kw:["pepperoni","peperoni"], k:80 }, { kw:["snack tajín","snack tajin","tajín","tajin"], k:36 }, { kw:["papilla mongui","mongui"], k:50 }, { kw:["licuado de fresa con plátano","licuado de fresa con platano","licuado de fresa y plátano","licuado de fresa y platano"], k:545 }, { kw:["licuado de fresa","licuado de fresas"], k:440 }, { kw:["licuado de mango","licuado mango"], k:490 }, { kw:["licuado de plátano","licuado de platano","licuado plátano","licuado platano"], k:495 }, { kw:["licuado","smoothie"], k:200 }, { kw:["jumex de uva","jugo de uva jumex","jumex uva"], k:174 }, { kw:["jugo de manzana jumex","jugo manzana jumex","jumex de manzana","jugo de manzana","jumex"], k:121 }, { kw:["jugo de naranja con zanahoria","jugo naranja zanahoria","jugo de naranja y zanahoria"], k:130 }, { kw:["jugo de naranja natural","jugo de naranja"], k:90 }, { kw:["jugo de zanahoria natural","jugo de zanahoria"], k:80 }, { kw:["galleta breton","galletas breton","breton"], k:40 }, { kw:["galleta salada","galletas saladas","galleta de soda","cracker","crackers"], k:13 }, { kw:["jugo"], k:120 }, { kw:["tequila","mezcal"], k:100 }, { kw:["palomitas"], k:250 },
